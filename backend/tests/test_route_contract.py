...
EXPECTED_OPERATIONS = {
    ...
    "/api/platform/availability": {"GET"},
    "/api/admin/availability": {"GET"},
    "/api/admin/availability/probes": {"POST"},
    "/api/markets": {"GET"},
    "/api/presets": {"GET"},
    "/api/search_us": {"GET"},
    "/api/analyze": {"GET"},
    ...
    "/api/portfolio/decision-twin/presets": {"GET"},
    "/api/portfolio/decision-twin/runs": {"GET", "POST"},
    "/api/portfolio/decision-twin/runs/{run_id}": {"GET"},
    "/api/portfolio/valuations/latest": {"GET"},
    "/api/portfolio/valuations/refresh": {"POST"},
    "/api/portfolio/valuations": {"GET"},
    "/api/portfolio/valuations/{snapshot_id}": {"GET"},
    "/api/portfolio/quant-lab/overview": {"GET"},
    "/api/portfolio/quant-lab/runs": {"GET", "POST"},
    "/api/portfolio/quant-lab/runs/{run_id}": {"GET"},
    "/api/portfolio/quant-lab/runs/{run_id}/mandates": {"POST"},
    "/api/portfolio/quant-lab/mandates": {"GET"},
    "/api/portfolio/quant-lab/mandates/{mandate_id}": {"GET"},
    ...
    "/api/portfolio/capital-decision": {"GET"},
    "/api/portfolio/capital-decision/plans": {"GET", "POST"},
    "/api/portfolio/capital-decision/plans/{plan_id}": {"GET"},
    "/api/portfolio/capital-decision/learning": {"GET"},
    "/api/portfolio/capital-decision/plans/{plan_id}/execution": {"GET"},
    "/api/portfolio/capital-decision/plans/{plan_id}/execution-events": {"POST"},
    "/api/portfolio/capital-decision/plans/{plan_id}/execution-review": {"POST"},
    "/api/portfolio/capital-decision/plans/{plan_id}/outcomes": {"GET", "POST"},
    "/api/portfolio/capital-decision/outcome-jobs/{job_id}": {"GET"},
    "/api/portfolio/capital-decision/outcomes/{outcome_id}": {"GET"},
    ...
    "/api/market/providers/probe": {"POST"},
    "/api/sectors": {"GET"},
    "/api/market/daily": {"GET"},
    "/api/v1/opportunities/templates": {"GET"},
    "/api/v1/opportunities/overview": {"GET"},
    "/api/v1/opportunities/profit-lab": {"GET"},
    "/api/v1/opportunities/regime": {"GET"},
    "/api/v1/opportunities/regime/snapshots": {"GET", "POST"},
    "/api/v1/opportunities/regime/snapshots/{snapshot_id}": {"GET"},
    "/api/v1/opportunities/committee": {"GET"},
    "/api/v1/opportunities/committee/mandates": {"GET", "POST"},
    "/api/v1/opportunities/committee/mandates/{mandate_id}": {"GET"},
    "/api/v1/opportunities/profit-scorecards": {"GET"},
    "/api/v1/opportunities/profit-scorecards/{scorecard_id}": {"GET"},
    "/api/v1/opportunities/strategies": {"GET", "POST"},
    "/api/v1/opportunities/strategies/{strategy_id}": {"GET", "DELETE"},
    "/api/v1/opportunities/strategies/{strategy_id}/versions": {"POST"},
    "/api/v1/opportunities/strategies/{strategy_id}/profit-policy": {"GET"},
    "/api/v1/opportunities/strategies/{strategy_id}/profit-policy/versions": {"POST"},
    "/api/v1/opportunities/strategies/{strategy_id}/profit-scorecards": {"POST"},
    "/api/v1/opportunities/runs": {"GET", "POST"},
    "/api/v1/opportunities/runs/{run_id}": {"GET"},
    "/api/v1/opportunities/runs/{run_id}/paper-baskets": {"POST"},
    "/api/v1/opportunities/paper-baskets": {"GET"},
    "/api/v1/opportunities/paper-baskets/{basket_id}": {"GET"},
    "/api/v1/opportunities/paper-baskets/{basket_id}/observations": {"POST"},
    "/api/v1/quant-selection/overview": {"GET"},
    "/api/v1/quant-selection/research-programs": {"GET", "POST"},
    "/api/v1/quant-selection/research-programs/{program_id}": {"GET"},
    "/api/v1/quant-selection/research-programs/{program_id}/reconcile": {"POST"},
    "/api/v1/quant-selection/research-programs/{program_id}/retire": {"POST"},
    "/api/v1/quant-selection/runs": {"GET", "POST"},
    "/api/v1/quant-selection/runs/{run_id}": {"GET"},
    "/api/v1/quant-selection/runs/{run_id}/shadow-mandates": {"POST"},
    "/api/v1/quant-selection/shadow-mandates": {"GET"},
    "/api/v1/quant-selection/shadow-mandates/{mandate_id}": {"GET"},
    "/api/v1/quant-selection/shadow-mandates/{mandate_id}/forward-validations": {"POST"},
    "/api/v1/quant-selection/forward-validations": {"GET"},
    "/api/v1/quant-selection/forward-validations/{validation_id}/observations": {"POST"},
    "/api/v1/quant-factors/overview": {"GET"},
    "/api/v1/quant-factors/sync-runs/{run_id}": {"GET"},
    "/api/v1/quant-factors/backfill-plans": {"POST"},
    "/api/v1/quant-factors/backfill-plans/{plan_id}/actions": {"POST"},
    "/api/v1/quant-factors/sync-runs": {"POST"},
    "/api/v1/quant-factors/schedule": {"POST"},
    "/api/v1/alpha-forecasts/overview": {"GET"},
    "/api/v1/alpha-forecasts/programs": {"POST"},
    "/api/v1/alpha-forecasts/programs/{program_id}": {"GET"},
    "/api/v1/alpha-forecasts/programs/{program_id}/runs": {"POST"},
    "/api/v1/alpha-forecasts/programs/{program_id}/actions": {"POST"},
