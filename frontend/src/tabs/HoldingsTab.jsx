...
export default function HoldingsTab() {
  ...
  function updateParsed(index, key, value) {
    setParsed((rows) => rows.map((row, idx) => {
      ...
      const next = { ...row, [key]: ['amount', 'cost', 'profit', 'profit_rate', 'shares'].includes(key) ? (value === '' ? null : Number(value)) : value }
        ...
        <div className="panel fade-in">
          ...
          <div className="corr-wrap">
            <table className="compact-table holdings-edit-table">
              <thead>
                <tr>
                  <th>类型</th><th>市场</th><th>代码</th><th>名称</th><th>金额</th><th>成本</th><th>收益</th><th>收益率</th><th>份额</th><th></th>
                </tr>
              </thead>
              <tbody>
                {parsed.map((row, idx) => (
        ...
        <div className="panel fade-in">
          ...
          <div className="corr-wrap">
            <table className="compact-table holdings-table">
              <thead>
                <tr>
                  <th>类型</th><th>市场</th><th>代码</th><th>名称</th><th>金额</th><th>成本</th><th>收益</th><th>收益率</th><th>来源</th><th></th>
                </tr>
              </thead>
              <tbody>
                {items.map((row) => (
