...
- 新增统一研究源与信号完整性契约测试；后端全量回归 `466 passed`、`4 subtests passed`，前端 Vite 生产构建通过。详细设计与验收记录见 [`docs/updates/2026-07-22-007-decision-operating-system.md`](docs/updates/2026-07-22-007-decision-operating-system.md)。
